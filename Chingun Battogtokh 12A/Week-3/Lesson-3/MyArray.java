...
public class MyArray
{
  ...
  private String[] Chingun = {"wew","pro","mid","injoker","hello"}; 
...
public int getSizeOfArrayBilguundalai()
  ...
  public int getSizeOfArrayChingun() 
  { 
      return Chingun.length;
    } 
  public String getMyElementChingun(int index) 
  { 
      return Chingun[index]; 
    }
  public void addNumberChingun(String num, int index)
  { 
      Chingun[index] = num; 
    } 
