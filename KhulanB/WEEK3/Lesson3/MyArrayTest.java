...
public class MyArrayTest
{
  ...
  public void khangaridTest()
  {
    ...
    assertEquals(1.5f,1, myObj.getMyElementKhangarid(3));   
  }
    @Test
...
@Test
  ...
  {
    MyArray myObj =  new MyArray();
    assertEquals(4,myObj.getSizeofArrayjuanCarlos());
    assertEquals(1,myObj.getMyElementjuanCarlos(0));
    assertEquals(6,myObj.getMyElementjuanCarlos(1));
    assertEquals(8,myObj.getMyElementjuanCarlos(2));
    assertEquals(3,myObj.getMyElementjuanCarlos(3));
  }
  @Test
