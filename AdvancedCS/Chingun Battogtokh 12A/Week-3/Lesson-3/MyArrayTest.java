...
{ 
  ...
  public void khulanTest()
  {
    ...
    assertEquals(1.2, myObj.getMyElementKhulan(0),1);
    assertEquals(2.9, myObj.getMyElementKhulan(1),1);
    assertEquals(3.4, myObj.getMyElementKhulan(2),1);
    assertEquals(4.6, myObj.getMyElementKhulan(3),1);
  }
  @Test
  ...
  { 
    ...
    assertEquals(5, c4.getSizeOfArrayChingun()); 
    assertEquals("wew", c4.getMyElementChingun(0)); 
    assertEquals("pro", c4.getMyElementChingun(1));
    assertEquals("mid", c4.getMyElementChingun(2)); 
    assertEquals("injoker", c4.getMyElementChingun(3)); 
    assertEquals("hello", c4.getMyElementChingun(4));
  } 
