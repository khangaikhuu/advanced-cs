 ...
 */
    // Today's topic lesson objectives Arrays
...
public class ClassArray
{
  ...
  private String[] bilguundalai = {"5","4","1", "pro", "JutsuMeister"};
  private int [] haYeon = {};
 ...
 public int getSizeOfArrayHannah()
  ...
  public double getMyElementHannah(int index)
  {
   return hannah[index]; 
    ...
    public String getMyElementMsAminerdene(int index)
  {
    return msAminerdene[index];
  }
  public int getSizeOfArrayMsAminerdene()
  {
