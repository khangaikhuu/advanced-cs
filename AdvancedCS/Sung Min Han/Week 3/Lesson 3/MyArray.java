...
public class MyArray
{
  ...
  private String[] msAmina = {"Hey", "Ohh", "Hi", "Ok"};
 ...
 public int getSizeOfArrayHannah()
  ...
  {
    return msAmina[index];
  }
  public int getSizeOfArrayMsAmina()
  {
        return msAmina.length;
  }
  ...
  public int sizeOfsungMinArray()
  {
     return sungMin.length; 
  }
  public void addElementSungMin(int num, int index)
  {
      sungMin[index] = num;
  }
  public int getMyElementSungMin(int index)
  {
      return sungMin[index];
  }
}
